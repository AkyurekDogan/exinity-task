...
const (
	CandleService_SubscribeCandles_FullMethodName = "/candle.CandleService/SubscribeCandles"
)
...
type CandleServiceClient interface {
	SubscribeCandles(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Candle], error)
}
...
func (c *candleServiceClient) SubscribeCandles(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Candle], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CandleService_ServiceDesc.Streams[0], CandleService_SubscribeCandles_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type CandleService_SubscribeCandlesClient = grpc.ServerStreamingClient[Candle]
...
type CandleServiceServer interface {
	SubscribeCandles(*SubscribeRequest, grpc.ServerStreamingServer[Candle]) error
...
func (UnimplementedCandleServiceServer) SubscribeCandles(*SubscribeRequest, grpc.ServerStreamingServer[Candle]) error {
...
func _CandleService_SubscribeCandles_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CandleServiceServer).SubscribeCandles(m, &grpc.GenericServerStream[SubscribeRequest, Candle]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CandleService_SubscribeCandlesServer = grpc.ServerStreamingServer[Candle]
...
var CandleService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/app/api/proto/candle.proto",
}
